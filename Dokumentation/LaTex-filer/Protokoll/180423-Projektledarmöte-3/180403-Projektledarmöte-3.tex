...
%\def\tTitleThree{Gruppmöte - DD/MM-YY kl HH:mm}
\def\tTitleThree{Projektledarmöte 3 - 23/04-18 kl 13:15}
...
%======
\def\tAuthorThreeName{Isak Söderström \textit{- projektledare}}      % <-- Set to {} to hide
...
%% Misc
\def\tDateDocMade{3 april 2018}     % Use \today or set a date manually
